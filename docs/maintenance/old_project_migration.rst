...
For pieces composed for the EN325 or the HuFo his can be done using the reascripts in this `repo <https://github.com/TU-Studio/ReaScripts>`_.
...
4. set the value for `scaling_factor` to :math:`6.046` for the EN325 or to :math:`12.108` if its a HuFo piece
